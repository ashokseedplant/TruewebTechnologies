  ...
  return (
    <div className="bg-white dark:bg-gray-950">
      <main className="container mx-auto pt-24 md:pt-32 pb-12 px-4">
        ...
        {/* Case Study 1 */}
        <section className="mb-12 p-8 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-white dark:bg-gray-800">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">E-Commerce Store Traffic Boost</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div>
              <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Challenge</h3>
            ...
            <div>
              <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Strategy</h3>
              <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-medium mb-2 text-gray-900 dark:text-white">Results</h3>
              <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <p className="mt-2 font-medium text-gray-900 dark:text-white">— John Smith, CEO of Fashion Retailer</p>
          </div>
        </section>
        
        {/* Case Study 2 */}
        <section className="mb-12 p-8 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm bg-white dark:bg-gray-800">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Local Business Map Pack Dominance</h2>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <p className="mt-2 font-medium text-gray-900 dark:text-white">— Sarah Johnson, Owner of Home Services Company</p>
          </div>
        </section>
        
        {/* CTA Section */}
        <section className="py-12 bg-blue-600 dark:bg-blue-800 rounded-lg">
          <div className="container mx-auto px-4">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-white mb-6">
                Ready to Improve Your SEO Results?
              </h2>
